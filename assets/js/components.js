/* ============================================================
   ONES — Components dùng chung (header, footer, cards, icons)
   ============================================================ */
...
function statusPill(p) {
  ...
  if (/sắp/i.test(s)) return '<span class="pill pill--gold">' + s + "</span>";
  if (/mở bán|phân phối/i.test(s)) return '<span class="pill pill--status">' + s + "</span>";
  return '<span class="pill pill--ghost">' + s + "</span>";
}
...
function buildHeader() {
  ...
  '<header class="site-header" id="siteHeader">' +
    '<div class="container">' +
      '<a class="brand" href="/index.html"><img src="/assets/img/logo.png" alt="OneS — Kiến tạo giá trị thịnh vượng"></a>' +
      ...
      '<div class="header-cta">' +
        ...
        '<a class="btn" href="/doi-tac.html#apply">Trở thành đối tác ' + ICONS.arrow + "</a>" +
      "</div>" +
  ...
  '<div class="mobile-nav" id="mobileNav">' + mlinks +
    '<div class="m-foot"><a class="btn" href="/doi-tac.html#apply" style="margin-bottom:1rem">Trở thành đối tác ' + ICONS.arrow + '</a><br><a href="tel:' + SITE.hotlineRaw + '" style="color:var(--red);font-weight:700">' + SITE.hotline + "</a><br>" + SITE.email + "</div>" +
  "</div>";
}
    ...
    '<div class="container">' +
      '<div class="footer-top">' +
        '<div class="footer-brand">' +
          '<img src="/assets/img/logo-white.png" alt="OneS">' +
          "<p>" + SITE.legalName + " là công ty công nghệ trong lĩnh vực bất động sản cao cấp: cung cấp nguồn sản phẩm từ các chủ đầu tư uy tín và nền tảng hỗ trợ bán hàng cho đối tác, cộng tác viên.</p>" +
          '<div class="footer-soc">' +
            ...
            '<a href="' + SITE.tiktok + '" target="_blank" rel="noopener" aria-label="TikTok">' + ICONS.tiktok + "</a>" +
            '<a href="' + SITE.zalo + '" target="_blank" rel="noopener" aria-label="Zalo OA">' + ICONS.zalo + "</a>" +
          "</div>" +
        "</div>" +
        '<div class="footer-col"><h4>Khám phá</h4><ul>' + nav + '<li><a href="/doi-tac.html#apply">Đăng ký cộng tác viên</a></li></ul></div>' +
        '<div class="footer-col"><h4>Danh mục sản phẩm</h4><ul>' +
          '<li><a href="/du-an.html?type=C%C4%83n%20h%E1%BB%99">Căn hộ cao cấp &amp; hạng sang</a></li>' +
          '<li><a href="/du-an.html?type=Khu%20%C4%91%C3%B4%20th%E1%BB%8B">Khu đô thị &amp; đại đô thị</a></li>' +
          '<li><a href="/du-an.html?type=Nh%C3%A0%20ph%E1%BB%91%20%26%20Bi%E1%BB%87t%20th%E1%BB%B1">Nhà phố &amp; biệt thự</a></li>' +
          '<li><a href="/du-an.html">Toàn bộ giỏ hàng</a></li>' +
        "</ul></div>" +
        '<div class="footer-col footer-contact"><h4>Liên hệ</h4><ul>' +
          ...
          '<li>' + ICONS.building + '<span>MST: ' + SITE.taxId + "</span></li>" +
        "</ul></div>" +
      "</div>" +
      '<div class="footer-bottom">' +
        "<span>© " + new Date().getFullYear() + " " + SITE.legalName + ". Bảo lưu mọi quyền.</span>" +
        '<span>' + SITE.tagline + ' · <a href="/admin.html" style="opacity:.65">Quản trị</a></span>' +
      "</div>" +
    "</div>" +
  "</footer>";
}
...
function buildFloatContact() {
  return '' +
    '<a class="fc-zalo pulse" href="' + SITE.zalo + '" target="_blank" rel="noopener" aria-label="Zalo OA OneS"><span class="float-label">Zalo OA OneS</span>' + ICONS.zalo + "</a>" +
...
if (typeof window !== "undefined") {
  ...
  window.renderProjectCard = renderProjectCard; window.statusPill = statusPill;
